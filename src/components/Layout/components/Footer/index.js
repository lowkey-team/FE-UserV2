    ...
    <div className={cx("footer-wrapper")}>
      <div className={cx("footer-introduce")}>
        <div className={cx("value")}>
          ...
          <h2>Sản phẩm</h2>
          <p>
            Được sản xuất từ làng nghề nổi tiếng Việt Nam. Showroom sản phẩm thủ
            công mỹ nghệ lớn nhất tại TPHCM
          </p>
        </div>
        ...
        <div className={cx("value")}>
          ...
          <p>
            Được sản xuất từ các nguyên liệu thiên nhiên, thân thiện với môi
            trường và không gây hại cho người sử dụng.
          </p>
        </div>
      </div>
      ...
      <div className={cx("footer")}>
        <div style={{ width: "400px" }} className={cx("footer-column")}>
          ...
          <p className={cx("company")}>
            Công ty cổ phẩn đầu tư - Phát triển Mỹ Nghệ Việt
          </p>
          <p>
      ...
      <div className={cx("footer-introduce")}>
        © 2024 My Nghe Viet. All rights reserved.
      </div>
    </div>
  );
}
